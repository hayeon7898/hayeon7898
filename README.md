<!--
**hayeon7898/hayeon7898** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- Built a fusion pipeline using Whisper, wav2vec, and ResNet-18 to address
  cross-modal inconsistency in emotional signals
...
- Designed hybrid optimization pipelines under limited measurement (probing)
  budgets, focusing on quantum state estimation and state transformation
- Validated quantum circuits through iterative execution on simulators
...
![ConvNeXt](https://img.shields.io/badge/ConvNeXt-000000)
![ResNet](https://img.shields.io/badge/ResNet-000000)
![LLaMA](https://img.shields.io/badge/LLaMA-6F42C1)

**Speech**  
![Whisper](https://img.shields.io/badge/Whisper-000000)
![wav2vec](https://img.shields.io/badge/wav2vec-4A90E2)
